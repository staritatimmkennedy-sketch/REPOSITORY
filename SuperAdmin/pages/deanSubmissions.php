...
<div id="deanSubmissions" class="p-6">
  <!-- Header -->
  <div class="bg-white border rounded-lg p-4 mb-6 shadow-sm flex flex-col sm:flex-row sm:items-center gap-3">
    <input type="text" id="searchSubmissions" placeholder="Search by title, author, or description..."
  ...
  <div class="bg-white rounded-lg shadow overflow-hidden">
    <table class="w-full border-collapse text-left" id="submissionsTable">
      ...
      <tbody>
        ...
        <tr class="border-b hover:bg-gray-50"
          ...
          <td class="px-4 py-3 text-sm">
            <span class="inline-block w-20 text-center px-2 py-1 rounded-md border bg-yellow-100 text-yellow-700 border-yellow-400 font-medium text-xs">
          ...
          <td class="px-4 py-3 text-center">
            <div class="relative inline-block text-left">
              ...
              <div class="hidden absolute right-0 mt-1 w-40 bg-white border rounded-md shadow-md z-50">
                ...
                <a href="#" class="block px-4 py-2 text-sm text-red-600 hover:bg-gray-100">Reject</a>
              </div>
            </div>
          </td>
        </tr>
