...
<div id="colleges" class="p-6">
  ...
  <!-- College Cards - 2x2 Grid -->
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <?php foreach ($colleges as $c): 
      // Define color schemes for each college
      $colorClasses = [
        'orange' => [
          'header' => 'bg-gradient-to-r from-orange-100 to-orange-50 border-orange-200',
          'accent' => 'text-orange-600',
          'button' => 'bg-blue-100 hover:bg-blue-200 text-blue-700 border-blue-300' // Changed to blue
        ],
        'blue' => [
        ...
        'manta' => [
          'header' => 'bg-gradient-to-r from-gray-100 to-gray-50 border-gray-300',
      ...
      $colorScheme = $colorClasses[$c['color']];
    ?>
      ...
      <div class="<?= $colorScheme['header'] ?> border-b p-4">
        <div class="flex items-center">
          ...
          <div class="mr-3 p-2 rounded-md bg-white shadow-sm">
            <?php 
              // Different SVG for each college type
              if ($c['id'] == 1) {
      ...
      <div class="p-4">
        ...
        <div class="mt-4">
          <div class="flex justify-between text-xs text-gray-600 mb-1">
            ...
            <span><?= round(($c["approved"] / $c["submissions"]) * 100, 1) ?>%</span>
          </div>
          <div class="w-full bg-gray-200 rounded-full h-1.5">
            <div class="bg-green-500 h-1.5 rounded-full" style="width: <?= ($c["approved"] / $c["submissions"]) * 100 ?>%"></div>
          </div>
        </div>
