<div id="editCourseModal" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 hidden opacity-0 transition-opacity duration-300">
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md" onclick="event.stopPropagation()">

        <div class="flex justify-between items-center mb-4">
            <h2 class="text-lg font-bold" id="editCourseModalTitle">Edit Course</h2>
            <button type="button" id="close-edit-course-modal-btn" class="text-gray-400 hover:text-gray-600">
        ...
        <form id="edit-course-form" data-custom-handler="true">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <p id="edit_course_id_display" class="w-full border border-gray-300 rounded-md px-3 py-2 bg-gray-50 text-gray-700"></p>
                </div>
                <div>
                    <label for="edit_course_name" class="block text-sm font-medium text-gray-700 mb-1">Course Name <span class="text-red-500">*</span></label>
                ...
                <div>
                    <label for="edit_college_id" class="block text-sm font-medium text-gray-700 mb-1">College <span class="text-red-500">*</span></label>
                    <select name="college_id" id="edit_college_id" 
            ...
            <div class="flex justify-end space-x-2 mt-4">
                <button type="button" id="cancel-edit-course-modal-btn" 
