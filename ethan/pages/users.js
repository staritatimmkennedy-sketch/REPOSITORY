document.addEventListener("DOMContentLoaded", () => {
    ...
    // ----------------------------
// SUBMIT ADD USER FORM (FIXED VERSION)
// ----------------------------
// ----------------------------
// SUBMIT ADD USER FORM (FIXED VERSION)
// ----------------------------
...
if (addUserForm) {
    addUserForm.addEventListener("submit", (e) => {
        ...
        .then(data => {
            ...
            if (data.success) {
                if (data.user_id) {
                    // We have the actual database user_id - create the row with correct ID
    ...
    // -----------------------------
    // -----------------------------
// SUBMIT DELETE USER FORM (FIXED VERSION)
// -----------------------------
if (deleteUserForm) {
    deleteUserForm.addEventListener("submit", (e) => {
        ...
        .then(data => {
            if (data.success) {
                ...
                // Always refresh to ensure everything is in sync
                filterUsers();
