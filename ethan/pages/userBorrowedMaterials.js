$(function () {
    ...
    function initializeActions() {
        ...
        $(document).off('click', '.view-material').on('click', '.view-material', function (e) {
            ...
            console.log('Fetching material for callNumber:', callNumber);
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#viewMaterialContent').text(data || 'No content available.');
                    console.log('Removing hidden class from viewModal, current classes:', $viewModal.attr('class'));
                ...
                error: function (xhr, status, error) {
                    ...
                    $('#viewMaterialContent').text('Error loading material content: ' + (xhr.responseText || 'Unknown error.'));
                    $viewModal.removeClass('hidden');
                    $detailsModal.addClass('hidden');
                    $returnModal.addClass('hidden');
                    $('.dropdown-menu').addClass('hidden');
