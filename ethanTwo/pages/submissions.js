$(document).ready(function () {
  ...
  function getLibrarianStatusColor(status) {
    const colors = {
      'Not Published': "w-[100px] border-gray-400 bg-gray-100 text-gray-700",
      Published: "w-[84px] border-blue-500 bg-blue-100 text-blue-700",
      Rejected: "w-[84px] border-red-500 bg-red-100 text-red-700",
      'Available': "w-[84px] border-green-500 bg-green-100 text-green-700",
      'Borrowed': "w-[84px] border-purple-500 bg-purple-100 text-purple-700"
    };
    return colors[status] || "w-[84px] border-gray-300 bg-gray-100 text-gray-700";
  }
